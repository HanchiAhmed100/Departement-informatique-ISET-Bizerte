...
<div class="uk-padding-large">
    <div class="row">
        <div class="col-sm-7">
          <h4 class="text-center"> Ajouter Les Activité realiser par les clubs</h4>
        ...
        <div class="col-sm-5 uk-background-muted" style="height: 450px; overflow: scroll;overflow-x: hidden;">
            <h4 class="text-center uk-padding-small">  Les Activité realiser par les clubs</h4>
            <hr>
              <div id="posts"></div>
          </div>   
        </div>
...
<div id="footer"></div>
  ...
  <script type="text/javascript" src="js/uikit.min.js"></script>
        <script type="text/javascript">
          ...
          $("#posts").load("Assets/GetClub.php",{id:<?php echo($id); ?>},function(a,b){});
           

          function sendPoste(text,bod){
            $.post("Assets/SendClub.php",{title:text,body:bod},function(a,b){if(b == "success"){UIkit.notification({message: 'Article Ajouter avec succss', pos: 'bottom-center', status: 'primary'})}});
            setTimeout(function(){$("#posts").load("Assets/GetClub.php",{id:<?php echo($id); ?>},function(a,b){});},1000);
          }
          
          function DeletePost(id){
            $.post("Assets/Deleteclub.php",{id:id},function(a,b){if(b =="success"){UIkit.notification({message: 'Article supprimer', pos: 'bottom-center', status: 'primary'})}});
            setTimeout(function(){$("#posts").load("Assets/GetClub.php",{id:<?php echo($id); ?>},function(a,b){});},1000);
          }
          
          function UpdatePost(id){
            $('#modal').load("Assets/GetOneClub.php",{id:id},function(a,b){});
          }
          
          function SetUpdate(text,bod,id){
            $.post("Assets/UpdateClub.php",{title:text,body:bod,id:id},function(a,b){if(b == "success"){UIkit.notification({message: 'Mise à jour effectuée', pos: 'bottom-center', status: 'primary'})}});
            setTimeout(function(){$("#posts").load("Assets/GetClub.php",{id:<?php echo($id); ?>},function(a,b){});},1000);
