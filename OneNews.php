...
<div class="uk-background-muted">
  ...
  <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
     ...
     <div>
         ...
         <h1 class="uk-card-title uk-text-large uk-text-capitalize"><a href="index.php#act" Class="uk-text-left"><i class="fa fa-reply-all"></i></a>    '.$p['title'].' </h1>
             <p> '.$p['body'].'</p>';
             if( $p['pdf'] != "0" )
